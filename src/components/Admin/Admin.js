...
const Admin = () => {
    ...
    const onSubmit = data => {
        ...
        const url = `https://young-garden-33771.herokuapp.com/addProduct`;
        fetch(url, {
            method: 'POST',
            headers: {
    ...
    const handleImageUpload = event => {
        ...
        imageData.set('key', 'a9b18a986112e174efecac03166dac36');
            ...
            <main className={classes.content}>
                ...
                <Container maxWidth="lg" className={classes.container}>
                    ...
                    <form className="w-25" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <br></br>
                        <input onChange={handleImageUpload} type="file" name="exampleRequired" />
                        <br></br>
                        <br></br>
